...
public class FilestoreRequest extends DPRequest {
	...
	public void setAnnotated(boolean annotated) {
		...
		this.getFilestoreElement.setAttribute("annotated", Boolean.toString(this.annotated));
	}

	public void setNoSubdirectories(boolean noSubdirectories) {
		this.noSubdirectories = noSubdirectories;
		this.getFilestoreElement.setAttribute("no-subdirectories", Boolean.toString(this.noSubdirectories));
	}

	public void setLayoutOnly(boolean layoutOnly) {
		this.layoutOnly = layoutOnly;
		this.getFilestoreElement.setAttribute("layout-only", Boolean.toString(this.layoutOnly));
	}

	private void createGetFilestoreElement() {
		this.getFilestoreElement = new Element("get-filestore", "http://www.datapower.com/schemas/management");

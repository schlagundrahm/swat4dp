 ...
 * 
 * The DownloadFileRequest class is a Myarch dpduddy framework extension that
 * implements a "get-file" SOMA request.
 * 
...
public class DownloadFileRequest extends DPRequest {
	...
	private void createGetFileElement() {
		this.getFileElement = new Element("get-file",
	...
	public DPResponse execute(DPConnection connection) {
		...
		DownloadFileResponse response = (DownloadFileResponse) client
				.executeRequest(connection, this);
		return response;
	}
